...
//       if (response.detail === "User is not enrolled in Mentorship Programme. Payment has to be done successfully to be enrolled.") {
//         navigate("/payment");
//       } else {
//         const responseData = response.data.data;
//         setResponseMessage(response.data.message);
...
//     } catch (error) {
//       console.error("Error submitting form:", error);
//       setResponseMessage("Please confirm your payment .");
...
//             <button className="coformbtn" type="submit" onClick={handleSubmit}>
//               SUBMIT
//             </button>
//           </form>
...
const CompatibilityStage1 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.detail === "User is not enrolled in Mentorship Programme. Payment has to be done successfully to be enrolled.") {
        navigate("/payment");
      } else {
        const responseData = response.data.data;
        setResponseMessage(response.data.message);
