...
<section id="Mentorship">   
  <div className="Mentorship"> 
    ...
    <div className="mentorship-text">
        ...
        <p>Welcome to the ultimate mentorship experience designed to elevate your JEE Main & Advance preparation journey. Join the exclusive VJ Sir’s Mentorship Batch and unlock the path to success in JEE.</p>
    </div>

    <div className="mentorship-imgs">

      <div className="mentorship-img1 mentorship-img"><img src="src\images\Rectangle 21.png" alt="" /></div>

<div className="mentorship-img2 mentorship-img" ><img  src="src\images\Group 8.png" alt="" />
...
<div className="Discount">
<img src="src\images\pencil.png" alt="" />
...
<div className="mentorship-btn">
  ...
  <button className="btn4">Buy Now</button>
      ...
      <div className="mentorship-img3 mentorship-img"><img src="src\images\Rectangle 22.png" alt="" /></div>
