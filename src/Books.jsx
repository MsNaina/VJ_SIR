...
<div className="Books-text">
    <img className="Books-text-img1" src="src\images\upper coma.png" alt="" />

    <h1>Books Emporium</h1>

    <img className="Books-text-img2"  src="src\images\down coma.png" alt="" />
</div>

<div className="carousel">
    
    <a href="#one" className="carousel-item">
        <img src="src\images\JEE.png" alt="" />
    </a>
    <a href="#two" className="carousel-item">
        <img src="src\images\NEET_I.png" alt="" />
    </a> 
    <a href="#three" className="carousel-item">
        <img src="src\images\NEET_II.png" alt="" />
    </a>
